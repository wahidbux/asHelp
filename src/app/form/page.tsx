    ...
    return (
      <div className="min-h-screen w-full relative bg-black text-white md:h-screen md:overflow-hidden overflow-y-auto md:overflow-y-hidden">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-start pt-12 px-4">
          ...
          {step === 4 && (
            <div className="bg-white/10 backdrop-blur-lg rounded-xl mt-10 p-8 w-full max-w-2xl shadow-xl flex flex-col items-center">
              <BlurText
                text="Payment"
                delay={150}
                animateBy="words"
                direction="top"
                className="text-xl font-semibold mb-1 text-white text-center"
              />
              <p className="text-sm text-gray-300 mb-6 text-center">Step 4 of 4</p>
