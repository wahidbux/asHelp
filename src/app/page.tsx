...
// IMPORTED AnimatePresence for exit animations and the new HomePageSkeleton
...
export default function BackgroundBoxesDemo() {
  ...
  return (
    <div className="relative bg-slate-900">
      ...
      {/* The main content now fades in correctly after the skeleton loader fades out */}
      <div className={cn("transition-opacity duration-700 ease-in-out", isLoading ? 'opacity-0' : 'opacity-100')}>
        <NavbarDemo />
